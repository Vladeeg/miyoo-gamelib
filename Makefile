...
MIYOO_CXXFLAGS := -I$(MIYOO_PREFIX)/usr/include/SDL -O2 -D_GNU_SOURCE=1 -D_REENTRANT
MIYOO_LDFLAGS := -L$(MIYOO_PREFIX)/usr/lib -lSDL -lSDL_image -lSDL_ttf -lSDL_mixer -lm -lpthread
